...
\end{align*} 
It is easy to see that for a reasonably large $d$ such as $d \geq 6$, the first term is completely dominated by the second term. By taking partial derivatives about $\rho$ on the exponential term, we can easily find out $\rho = 1/4$ minimized the running time. Hence, 
\begin{align*}
